...
const Profile = () => {
    ...
    return (
        <div className="min-h-screen flex justify-center bg-secondary">
            <ToastContainer />
            <div className="bg-primary p-8 rounded-xl shadow-[0px_0px_20px_0px] shadow-[#30C7D6] w-full max-w-md h-1/2 mt-32">
